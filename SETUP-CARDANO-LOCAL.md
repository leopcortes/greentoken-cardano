# Configuração do Ambiente Local Blockchain Cardano

Guia passo a passo para configurar o ambiente de desenvolvimento local com cardano-node e cardano-cli, na rede **Preprod** (testnet).
